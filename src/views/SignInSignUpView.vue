      ...
      <div class="login-form">
        <form class="cmxform" id="signinForm" method="get" action="About.html">  
            <div class="sign-in-htm">
              <div class="group">
                <label for="cname" class="label">Username</label>
                <input id="cname" v-model=name name="name" minlength="6" type="text" class="input" required>
              </div>
              <div class="group">
        ...
        <form class="cmxform" id="signupForm" method="get" action="About.html">
            <div class="sign-up-htm">
              <div class="group">
                ...
                <input id="user" name="name2" minlenght="6" type="text" class="input" required>
              </div>
              <div class="group">
